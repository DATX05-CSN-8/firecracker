...
use std::path::Path;
use std::{mem, ptr};
// use std::error::Error;  TODO AAA or thiserror::Error or io::Error? removed error strings as well at the moment OR   (err) => { if err.errno() =
use std::fmt::{Display, Formatter};
use libc::{timeval,setsockopt,SOL_SOCKET,SO_RCVTIMEO}; // TODO AAA think ok
